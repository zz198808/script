...
/***************************************************************************
 * 
 * Copyright (c) 2011 dongyuezhao.cn, Inc. All Rights Reserved
 * $Id: String.php,v 1.2 2010/03/09 12:05:29 dolfly Exp $ 
 * $Id: String.php,v 1.3 2011/03/02 16:30:00 dolfly Inf $ 
 * 
 **************************************************************************/
 
/**
 * @file String.php
 * @author dolfly(dolfly@foxmail.com)
...
class YZ_String
{
     ...
     * @example:
	 * YZ_String::bdstrpos('a-b-c-d-', '-', 2);  
     * '_'第2次在'a-b-c-d-'中出现的返回值为：4
     *
     * YZ_String::bdstrpos('a-b-c-d-', '-', 3);  
	 ...
	 *
     * @example:
     * YZ_String::substring('abca/need/asdfas', '/');  
     * 返回 'need', 两个'/'之间的字符串
	 *
     * YZ_String::substring('ab!before!need===', '!', '===')
     * 返回 'before!need'之间的字符串
	 *
     * YZ_String::substring('ab!before!need===', '!', '===', 1)
	 * 返回 'need',  === 之前最近一个!号间的字
	 *
	 * @author chenqiuwu(chenqiuwu@baidu.com)
     */
     ...
     *
     * @brief 截取某个字符串前几位字符
     * @examle echo YZ_String::cutBefore('ab!before!need===', '===', 4); //返回 need
     *
	 * @author chenqiuwu(chenqiuwu@baidu.com)
     */
